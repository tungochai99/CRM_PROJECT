                    ...
                    <form action="<c:url value="<%=UrlConst.USER_ADD %>" />" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <select id="role" name="role" data-toggle="select" class="form-control">
                                    <option ${user.roleId == 1 ? 'selected="true"' : '' } value="1">ADMIN</option>
                                    <option ${user.roleId == 2 ? 'selected="true"' : '' } value="2">LEADER</option>
                                    <option ${user.roleId == 3 ? 'selected="true"' : '' } value="3">STAFF</option>
                                </select>
                            </div>
